...
CREATE TABLE `tbl_database` (
  ...
  KEY `FKiteukkn7felcvmie9jw9j3yvj` (`user_id`)
...
LOCK TABLES `tbl_database` WRITE;
/*!40000 ALTER TABLE `tbl_database` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_database` ENABLE KEYS */;
UNLOCK TABLES;

...
CREATE TABLE `tbl_table` (
  ...
  `columns` varbinary(255) DEFAULT NULL,
  `table_name` varchar(255) DEFAULT NULL,
  `database_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`table_id`),
  KEY `FKkjau2c9h2h5rfiyvx4nsedlnk` (`database_id`),
  KEY `FK7fs13bhbp64af3txyrv758kkc` (`user_id`)
...
-- Dump completed on 2023-12-22  9:48:57
